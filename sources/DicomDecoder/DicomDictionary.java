...
The data type of Value(s) stored in this field is specified by the Data Element's VR. 
The VR for a given Data Element Tag can be determined using the Data Dictionary in PS3.6, 
or using the VR Field if it is contained explicitly within the Data Element. 
The VR of Standard Data Elements shall agree with those specified in the Data Dictionary.

The Value Multiplicity specifies how many Values with this VR can be placed in the Value Field. 
If the VM is greater than one, multiple values shall be delimited within the Value Field 
as defined previously in Section 6.4. 
The VMs of Standard Data Elements are specified in the Data Dictionary in PS3.6.

Value Fields with Undefined Length are delimited through the use of Sequence Delimitation Items 
and Item Delimitation Data Elements, which are described further in Section 7.5.j
...
class DicomDictionary {
	...
	public  Map  getDictionary() {
		...
		for (int i=0; i<dict.length; i++) {
			map.put(dict[i].substring(0,8), dict[i].substring(9));
		}
		return map;
	}
	...
	,"00080116=ResponsibleOrganization "
	,"00080117=ContextUID "
	...
	,"00081111=ReferencedProcedureStepSequence "
	...
	,"00082110=LossyImageCompression "
	...
	,"001910D0=RawDataType "
	,"001910D2=ProjectionAlgorithm "
	...
	,"00211003=SeriesFromWhichPrescribed "
	,"00211005=GenesisVersionNow "
	,"00211007=SeriesRecordChecksum "
	,"00211018=GenesisVersionNow "
	,"00211019=AcqreconRecordChecksum "
	,"00211020=TableStartLocation "
	...
	,"00211056=IntegerSlop "
	,"00211057=IntegerSlop "
	,"00211058=IntegerSlop "
	,"00211059=IntegerSlop "
	...
	,"00402006=PlacerOrderNum-ImagingServiceReq "
	,"00402007=FillerOrderNum-ImagingServiceReq "
	...
	,"0043102F=RawDataType "
	,"00431030=RawDataType "
	...
	,"21000500=ReferencedPrintJobSequence "
